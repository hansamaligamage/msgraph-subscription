...
namespace SendEmailTrigger
{
    public static class EmailTrigger
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            log.Info("Starting to process notifications");
        ...
        {
            log.Info("ProcessWebhookNotificationsAsync started!");
            string content = await req.Content.ReadAsStringAsync();
            log.Info($"Raw request content: {content}");
        ...
        {
            log.Info("CheckForSubscriptionChangesAsync!");
            bool success = false;
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                await htmlParser.ParseHtml(subject, content, log);
                success = true;
            }
            return success;
        }
        ...
        {
            log.Info($"Retriving new accessToken");
